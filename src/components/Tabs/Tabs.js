...
const Tabs = ({activeTabName,onClickTab}) => {
  ...
  const renderTabTitle =(tabTitle,isActvie,icon,id) =>(
    <div onClick={() => onClickTab(tabTitle)} id={id} className={`tab-item ${isActvie && "tab-border"}`}>
            <i className={icon}></i>
            <p>{tabTitle}</p>
    </div>
  )
          ...
          <div className="container">
            <div id='tab-1-content' className={`tab-content-item ${activeTabName === WATCH_ANYWHERE && "show"}`}>
                  <div className="tab-2-content-top">
                    <p className="text-lg">
                      Watch TV show and movies anywhere,anytime - personalized for you.
                    </p>
                    <Link to="/netflix-show" className="btn btn-lg">
                        Watch Free for 30 days
                    </Link>
          ...
          <div className="container">
            <div id='tab-3-content' className={`tab-content-item ${activeTabName === PICK_YOUR_PRICE && "show"}`}>
              ...
              <table className="table">
                ...
                <tbody>
                  <tr>
                    <td>Monthly Price after Months end on 30/08/2023</td>
                    <td>$2.55</td>
                    <td>$5.99</td>
                    <td>$8.99</td>
                  </tr>
                  ...
                  <tr>
                    <td>Watch on your phone ,tv ,tablet</td>
                    <td>
                      <i className="fas fa-check"></i>
                    </td>
                    <td>
                  ...
                  <tr>
                    <td>Unlimited Tv and Movie shows</td>
                    <td>
                      <i className="fas fa-check"></i>
                    </td>
                    <td>
